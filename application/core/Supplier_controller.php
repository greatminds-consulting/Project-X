...
class Supplier_controller extends CRM_Controller
{
    ...
    public function layout()
    {
        ...
        if ($this->use_head == true) {
            $this->template['head'] = $this->load->view('themes/' . active_supplier_theme() . '/head', $this->data, true);
        }

        $this->template['view'] = $this->load->view('themes/' . active_supplier_theme() . '/views/' . $this->view, $this->data, true);

        $this->template['footer'] = '';
        if ($this->use_footer == true) {
            $this->template['footer'] = $this->load->view('themes/' . active_supplier_theme() . '/footer', $this->data, true);
        }

        $this->template['scripts'] = '';
        if ($this->add_scripts == true) {
            $this->template['scripts'] = $this->load->view('themes/' . active_supplier_theme() . '/scripts', $this->data, true);
        }
        $this->load->view('themes/' . active_supplier_theme() . '/index', $this->template);
    }
}
