<div class="row">
  <div class="col-md-12 mtop10">
    ...
    <div class="row">
      <div class="col-md-<?php if($eventmanager->settings->view_milestones == 1){ echo 6; } else {echo 12;} ?>">
        <div class="form-group">
    ...
    <div class="row">
     ...
     <div class="col-md-6">
       <?php echo render_date_input('duedate','task_add_edit_due_date','',$eventmanager->deadline ? array('data-date-end-date'=>$eventmanager->deadline) : array()); ?>
     </div>
   </div>
 ...
 <?php if($eventmanager->settings->upload_on_tasks == 1){ ?>
 <hr />
