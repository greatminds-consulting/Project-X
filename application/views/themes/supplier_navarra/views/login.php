<div class="mtop40">
	...
	<div class="col-md-4 col-md-offset-4">
		...
		<div class="form-group">
			...
			<a href="<?php echo site_url('suppliers/register'); ?>" class="btn btn-success btn-block"><?php echo _l('clients_register_string'); ?>
			</a>
			<?php } ?>
		</div>
		<a href="<?php echo site_url('suppliers/forgot_password'); ?>"><?php echo _l('customer_forgot_password'); ?></a>
		<?php echo form_close(); ?>
	</div>
</div>
</div>
