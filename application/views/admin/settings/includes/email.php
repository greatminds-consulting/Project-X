...
<div class="tab-content">
	<div role="tabpanel" class="tab-pane active" id="email_config">
		...
		<div class="form-group">
            ...
            <div class="radio radio-inline radio-primary">
                <input type="radio" name="settings[email_protocol]" id="sendgrid" value="sendgrid" <?php if(get_option('email_protocol') == 'sendgrid'){echo 'checked';} ?>>
                <label for="mail">SendGrid</label>
            </div>
		</div>
		<div class="smtp-fields<?php if(get_option('email_protocol') == 'mail' || get_option('email_protocol') == 'sendgrid'    ){echo ' hide'; } ?>">
        ...
        <div class="sendgrid-fields <?php if(get_option('email_protocol') != 'sendgrid'){echo ' hide'; } ?>">
            <?php echo render_input('settings[smtp_email]','settings_email',get_option('smtp_email')); ?>
            <?php echo render_input('settings[sendgrid_api_key]','settings_email_sendgrid_key',get_option('sendgrid_api_key')); ?>
        </div>
