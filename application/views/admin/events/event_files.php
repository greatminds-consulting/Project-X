<?php echo form_open_multipart(admin_url('eventmanager/upload_file/'.$eventmanager->id),array('class'=>'dropzone','id'=>'eventmanager-files-upload')); ?>
<input type="file" name="file" multiple />
<?php echo form_close(); ?>
<small class="mtop5"><?php echo _l('eventmanager_file_visible_to_customer'); ?></small><br />
...
<div class="modal fade bulk_actions" id="eventmanager_files_bulk_actions" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="bulk_change">
          <div class="form-group">
            <label class="mtop5"><?php echo _l('eventmanager_file_visible_to_customer'); ?></label>
            <div class="onoffswitch">
      ...
      <div class="modal-footer">
        ...
        <a href="#" class="btn btn-info" onclick="eventmanager_files_bulk_action(this); return false;"><?php echo _l('confirm'); ?></a>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
<a href="#" data-toggle="modal" data-target="#eventmanager_files_bulk_actions" class="bulk-actions-btn table-btn hide" data-table=".table-eventmanager-files">
  <?php echo _l('bulk_actions'); ?>
</a>
<a href="#" onclick="window.location.href = '<?php echo admin_url('eventmanager/download_all_files/'.$eventmanager->id); ?>'; return false;" class="table-btn hide" data-table=".table-eventmanager-files"><?php echo _l('download_all'); ?></a>
<div class="clearfix"></div>

<table class="table dt-table scroll-responsive table-eventmanager-files" data-order-col="7" data-order-type="desc">
  <thead>
    <tr>
      <th data-orderable="false"><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="eventmanager-files"><label></label></div></th>
      ...
      <th><?php echo _l('eventmanager_file_visible_to_customer'); ?></th>
      <th><?php echo _l('eventmanager_file_uploaded_by'); ?></th>
      ...
      <tr>
        ...
        <td data-order="<?php echo $file['file_name']; ?>">
          ...
          <td data-order="<?php echo $file['visible_to_customer']; ?>">
            ...
            ?>
            <div class="onoffswitch">
              <input type="checkbox" data-switch-url="<?php echo admin_url(); ?>eventmanager/change_file_visibility" id="<?php echo $file['id']; ?>" data-id="<?php echo $file['id']; ?>" class="onoffswitch-checkbox" value="<?php echo $file['id']; ?>" <?php echo $checked; ?>>
         ...
         <td>
           ...
           <button type="button" data-toggle="modal" data-original-file-name="<?php echo $file['file_name']; ?>" data-filetype="<?php echo $file['filetype']; ?>" data-path="<?php echo EVENTMANAGER_ATTACHMENTS_FOLDER .$eventmanager->id.'/'.$file['file_name']; ?>" data-target="#send_file" class="btn btn-info btn-icon"><i class="fa fa-envelope"></i></button>
           <?php } ?>
           <?php if($file['staffid'] == get_staff_user_id() || has_permission('events','','delete')){ ?>
           <a href="<?php echo admin_url('eventmanager/remove_file/'.$eventmanager->id.'/'.$file['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
           <?php } ?>
         </td>
       </tr>
       <?php } ?>
