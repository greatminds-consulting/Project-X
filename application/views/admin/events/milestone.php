...
<div class="modal fade" id="milestone" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('eventmanager/milestone'),array('id'=>'milestone_form')); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                       <?php echo form_hidden('event_manager_id',$eventmanager->id); ?>
                        ...
                        <?php echo render_date_input('due_date','milestone_due_date','',($eventmanager->deadline) ? array('data-date-end-date'=>$eventmanager->deadline) : array()); ?>
                        ...
                        <?php echo render_input('milestone_order','eventmanager_milestone_order',total_rows('tblmilestones',array('event_manager_id'=>$eventmanager->id)) + 1,'number'); ?>
                    </div>
                </div>
            </div>
