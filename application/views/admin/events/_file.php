         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-8 border-right eventmanager_file_area">
                  <?php
                     if($file->staffid == get_staff_user_id() || has_permission('events','','create')){ ?>
                  <?php echo render_input('file_subject','eventmanager_discussion_subject',$file->subject,'text',array('onblur'=>'update_file_data('.$file->id.')')); ?>
                  <?php echo render_textarea('file_description','eventmanager_discussion_description',$file->description,array('onblur'=>'update_file_data('.$file->id.')')); ?>
                  <hr />
                  <?php } else { ?>
