...
<?php $table_data = array(
    _l('eventmanager_timesheet_user'),
    _l('eventmanager_timesheet_task'),
    _l('timesheet_tags'),
    _l('eventmanager_timesheet_start_time'),
    _l('eventmanager_timesheet_end_time'),
    _l('note'),
    _l('time_h'),
    _l('time_decimal'));
$table_data = do_action('eventmanager_timesheets_table_columns',$table_data);
array_push($table_data,_l('options'));
render_datatable($table_data,'timesheets'); ?>
<?php $this->load->view('admin/events/timesheet'); ?>
