...
<div class="modal fade" id="discussion" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('eventmanager/discussion'),array('id'=>'discussion_form')); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="checkbox" name="show_to_customer" checked id="show_to_customer">
                            <label for="show_to_customer"><?php echo _l('eventmanager_discussion_show_to_customer'); ?></label>
                        </div>
                    </div>
                </div>
            </div>
