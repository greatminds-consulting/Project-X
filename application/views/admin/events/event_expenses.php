      ...
      <a href="#" data-toggle="modal" data-target="#new_eventmanager_expense" class="btn btn-info mbot25"><?php echo _l('new_expense'); ?></a>
      <?php } ?>
      <?php
      ...
      $data_expenses_filter['filter_table_name'] = '.table-eventmanager-expenses';
      ...
      render_datatable($table_data,'eventmanager-expenses'); ?>
      <div class="modal fade" id="new_eventmanager_expense" tabindex="-1" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <?php echo form_open(admin_url('eventmanager/add_expense'),array('id'=>'eventmanager-expense-form','class'=>'dropzone dropzone-manual')); ?>
         ...
         $_customer_expense_data['userid'] = $eventmanager->client_data->userid;
         $_customer_expense_data['company'] = $eventmanager->client_data->company;
         $customer_expense_data[] = $_customer_expense_data;
         echo render_select('clientid',$customer_expense_data,array('userid','company'),'expense_add_edit_customer',$eventmanager->clientid); ?>
        ...
        <?php echo form_hidden('clientid',$eventmanager->clientid); ?>
        <div class="clearfix"></div>
      </div>
