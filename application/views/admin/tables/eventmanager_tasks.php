...
array_push($where,'AND CASE WHEN rel_type="eventmanager" AND rel_id IN (SELECT event_manager_id FROM tbleventsettings WHERE event_manager_id=rel_id AND name="hide_tasks_on_main_tasks_table" AND value=1) THEN rel_type != "eventmanager" ELSE 1=1 END');
