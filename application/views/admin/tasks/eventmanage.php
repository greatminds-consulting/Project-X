                        ...
                        <div class="row _buttons">
                            <div class="col-md-8">
                                <?php if(has_permission('tasks','','create')){ ?>
                                    <a href="#" onclick="new_task(<?php if($this->input->get('event_manager_id')){ echo "'".admin_url('tasks/task?rel_id='.$this->input->get('event_manager_id').'&rel_type=eventmanager')."'";} ?>); return false;" class="btn btn-info pull-left new"><?php echo _l('new_task'); ?></a>
                                <?php } ?>
                                <a href="<?php if(!$this->input->get('event_manager_id')){ echo admin_url('tasks/switch_kanban/'.$switch_kanban); } else { echo admin_url('eventmanager/view/'.$this->input->get('event_manager_id').'?group=event_tasks'); }; ?>" class="btn btn-default mleft10 pull-left hidden-xs">
                            ...
                            <div class="kan-ban-tab" id="kan-ban-tab" style="overflow:auto;">
                                <div class="row">
                                    <div id="kanban-params">
                                        <?php echo form_hidden('event_manager_id',$this->input->get('event_manager_id')); ?>
                                    </div>
