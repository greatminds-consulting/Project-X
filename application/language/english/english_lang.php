...
$lang['delete_archive_failure']        = 'Couldnot Delete Archive';
...
$lang['settings_general_delete_recycle_bin_period']          = 'Delete Recycle Bin Period';
$lang['settings_general_delete_recycle_bin_period_tooltip']  = 'When you add new recycle bin period this period will be selected by default';
...
$lang['area_layout_minimum']     = 'Area Layout Minimum';
$lang['area_layout_maximum']     = 'Area Layout Maximum';
$lang['area_layout']             = 'Layout';
$lang['venue_amenities']         = 'Venue Amenities';
$lang['amenities_title']         = 'Amenities';
$lang['amenities_name']          = 'Amenity Name';
$lang['layout_name']             = 'Layout Name';
$lang['new_amenities']           = 'New Amenities';
$lang['new_layout']              = 'New Layout';
$lang['new_amenity']             = 'New Amenities';
$lang['edit_amenity']            = 'Edit Amenity';
$lang['amenity']                 = 'Amenity';
$lang['layout']                  = 'Layout';
$lang['add_amenities']           = 'Add Amenities';
$lang['amenity_name']            = 'Name';
$lang['new_layouts']             = 'New Layouts';
...
$lang['not_lead_activity_name_changed'] = '%s updated lead name from %s to %s';
$lang['not_lead_activity_name_added'] = '%s added lead name %s';
$lang['not_lead_activity_name_removed'] = '%s removed lead name %s';
$lang['not_lead_activity_title_changed'] = '%s updated lead position from %s to %s';
$lang['not_lead_activity_title_added'] = '%s added lead position %s';
$lang['not_lead_activity_title_removed'] = '%s removed lead position %s';
$lang['not_lead_activity_email_changed'] = '%s updated lead email from %s to %s';
$lang['not_lead_activity_email_added'] = '%s added lead email %s';
$lang['not_lead_activity_email_removed'] = '%s removed lead email %s';
$lang['not_lead_activity_website_changed'] = '%s updated lead website from %s to %s';
$lang['not_lead_activity_website_added'] = '%s added lead website %s';
$lang['not_lead_activity_website_removed'] = '%s removed lead website %s';
$lang['not_lead_activity_is_public_changed'] = '%s updated lead from %s to %s';
$lang['not_lead_activity_phonenumber_changed'] = '%s updated lead phonenumber from %s to %s';
$lang['not_lead_activity_tag_removed'] = '%s removed lead tag %s';
$lang['not_lead_activity_tag_added'] = '%s added lead tag %s';
$lang['not_lead_activity_phonenumber_added'] = '%s added lead phonenumber %s';
$lang['not_lead_activity_phonenumber_removed'] = '%s removed lead phonenumber %s';
$lang['not_lead_activity_lastcontact_changed'] = '%s updated lead lastcontact from %s to %s';
$lang['not_lead_activity_lastcontact_added'] = '%s added lead lastcontact %s';
$lang['not_lead_activity_lastcontact_removed'] = '%s removed lead lastcontact %s';
$lang['not_lead_activity_company_changed'] = '%s updated lead company from %s to %s';
$lang['not_lead_activity_country_changed'] = '%s changed lead country from %s to %s';
$lang['not_lead_activity_company_added'] = '%s added lead company %s';
$lang['not_lead_activity_company_removed'] = '%s removed lead company %s';
$lang['not_lead_activity_address_changed'] = '%s updated lead address from %s to %s';
$lang['not_lead_activity_address_added'] = '%s added lead address %s';
$lang['not_lead_activity_address_removed'] = '%s removed lead address %s';
$lang['not_lead_activity_city_changed'] = '%s updated lead city from %s to %s';
$lang['not_lead_activity_city_added'] = '%s added lead city %s';
$lang['not_lead_activity_custom_Venue_added'] = '%s added lead  venue %s';
$lang['not_lead_activity_custom_Venue_changed'] = '%s changed lead  venue to %s';
$lang['not_lead_activity_custom_event_category_added'] = '%s added lead  event category %s';
$lang['not_lead_activity_custom_event_category_changed'] = '%s changed lead  event category to %s';
$lang['not_lead_activity_custom_PAX_added'] = '%s added lead  pax %s';
$lang['not_lead_activity_custom_PAX_changed'] = '%s changed lead  pax %s';
$lang['not_lead_activity_custom_Venue Requirements_changed'] = '%s changed lead  venue requirements to %s';
$lang['not_lead_activity_custom_Venue Requirements_added'] = '%s added lead  venue requirements  %s';
$lang['not_lead_activity_custom_Catering Requirements_changed'] = '%s changed lead  catering requirements to %s';
$lang['not_lead_activity_custom_Catering Requirements_added'] = '%s added lead  catering requirements  %s';
$lang['not_lead_activity_custom_AV Requirements_changed'] = '%s changed lead  AV requirements to %s';
$lang['not_lead_activity_custom_AV Requirements_added'] = '%s added lead  AV requirements  %s';
$lang['not_lead_activity_custom_Special Requirements_changed'] = '%s changed lead  special requirements to %s';
$lang['not_lead_activity_custom_Special Requirements_added'] = '%s added lead  special requirements  %s';
$lang['not_lead_activity_custom_Additional Services_changed'] = '%s changed lead  additional services to %s';
$lang['not_lead_activity_custom_Additional Services_added'] = '%s added lead  additional services  %s';
$lang['not_lead_activity_custom_Event Category_added'] = '%s added lead  event category %s';
$lang['not_lead_activity_custom_Event Category_changed'] = '%s changed lead  event category to %s';
$lang['not_lead_activity_custom_Event Type_added'] = '%s added lead  event type %s';
$lang['not_lead_activity_custom_Event Type_changed'] = '%s changed lead  event type to %s';
$lang["not_lead_activity_custom_Your partner's name_added"] = "%s added lead  partner's name %s";
$lang["not_lead_activity_custom_Your partner's name_changed"] = "%s changed lead partner's name to %s";
$lang["not_lead_activity_custom_Preferred date 1:_added"] = "%s added lead  preffered date1 %s";
$lang["not_lead_activity_custom_Preferred date 1:_changed"] = "%s changed lead preffered date1  to %s";
$lang["not_lead_activity_custom_Preferred date 2:_added"] = "%s added lead  preffered date2 %s";
$lang["not_lead_activity_custom_Preferred date 2:_changed"] = "%s changed lead preffered date2  to %s";
$lang["not_lead_activity_custom_Preferred date 3:_added"] = "%s added lead  preffered date2 %s";
$lang["not_lead_activity_custom_Preferred date 3:_changed"] = "%s changed lead preffered date2  to %s";
$lang['not_lead_activity_city_removed'] = '%s removed lead city %s';
$lang['not_lead_activity_state_changed'] = '%s updated lead state from %s to %s';
$lang['not_lead_activity_state_added'] = '%s added lead state %s';
$lang['not_lead_activity_state_removed'] = '%s removed lead state %s';
$lang['not_lead_activity_zip_changed'] = '%s updated lead zip from %s to %s';
$lang['not_lead_activity_zip_added'] = '%s added lead zip %s';
$lang['not_lead_activity_zip_removed'] = '%s removed lead zip %s';
$lang['not_lead_activity_description_changed'] = '%s updated lead description from %s to %s';
$lang['not_lead_activity_description_added'] = '%s added lead description %s';
$lang['not_lead_activity_description_removed'] = '%s removed lead description %s';
$lang['not_lead_activity_source_changed'] = '%s updated lead source from %s to %s';
$lang['not_lead_activity_source_added'] = '%s added lead source %s';
$lang['not_lead_activity_source_removed'] = '%s removed lead source %s';
...
$lang['home_my_eventmanager'] = 'My Events';
...
$lang['customer_permission_eventmanager']            = 'Events';
...
# Events
$lang['cant_change_billing_type_billed_tasks_found'] = 'You cant change billing type. Billed tasks already found for this event.';
$lang['eventmanager_customer_permission_warning'] = 'The system indicated that the primary contact do not have permission for eventmanagers. The primary contact won\'t be able to see the project. Consider add permission in the contact profile.';
$lang['eventmanager_invoice_timesheet_start_time'] = 'Start time: %s';
$lang['eventmanager_invoice_timesheet_end_time'] = 'End time: %s';
$lang['eventmanager_invoice_timesheet_total_logged_time'] = 'Logged time: %s';
$lang['eventmanager_view_as_client'] = 'View event as customer';
$lang['eventmanager_mark_all_tasks_as_completed'] = 'Mark all tasks as completed and stop all timers (No notifications sent to eventmanager members)';
$lang['eventmanager_not_started_status_tasks_timers_found'] = 'Task timers found for this eventmanager but the eventmanager is with status Not Started. Recommended to change the eventmanager status to In Progress';
$lang['eventmanager_status'] = 'Status';
$lang['eventmanager_status_1'] = 'Not Started';
$lang['eventmanager_status_2'] = 'In Progress';
$lang['eventmanager_status_3'] = 'On Hold';
$lang['eventmanager_status_4'] = 'Finished';
$lang['eventmanager_status_5'] = 'Cancelled';
$lang['eventmanager_file_dateadded'] = 'Date uploaded';
$lang['eventmanager_file_filename'] = 'Filename';
$lang['eventmanager_file__filetype'] = 'File type';
$lang['eventmanager_file_visible_to_customer'] = 'Visible to Customer';
$lang['eventmanager_file_uploaded_by'] = 'Uploaded by';
$lang['edit_eventmanager'] = 'Edit Event';
$lang['copy_eventmanager'] = 'Copy Event';
$lang['delete_eventmanager'] = 'Delete Event';
$lang['eventmanager_task_assigned_to_user'] = 'Task assigned to you';
$lang['seconds'] = 'Seconds';
$lang['hours'] = 'Hours';
$lang['minutes'] = 'Minutes';
$lang['eventmanager']                 = 'event';
$lang['eventmanager_lowercase']       = 'event';
$lang['eventmanager_uppercase']       = 'Event';
$lang['event_lowercase']                = 'event';
$lang['eventmanagers']                = 'events';
$lang['eventmanagers_lowercase']      = 'events';
$lang['eventmanager_settings']      = 'events settings';
$lang['eventmanager_invoiced_successfully']             = 'Events Invoiced Successfully';
$lang['new_eventmanager']             = 'New Event';
$lang['eventmanager_files']            = 'Files';
$lang['eventmanager_activity']            = 'Activity';
$lang['eventmanager_name']            = 'Event Name';
$lang['eventmanager_description']            = 'Description';
$lang['eventmanager_customer']            = 'Customer';
$lang['eventmanager_start_date']            = 'Start Date';
$lang['eventmanager_datecreated']            = 'Date Created';
$lang['eventmanager_deadline']            = 'Deadline';
$lang['eventmanager_billing_type']            = 'Billing Type';
$lang['eventmanager_billing_type_fixed_cost']            = 'Fixed Rate';
$lang['eventmanager_billing_type_eventmanager_hours']            = 'Event Hours';
$lang['eventmanager_billing_type_eventmanager_task_hours']            = 'Task Hours';
$lang['eventmanager_billing_type_eventmanager_task_hours_hourly_rate']            = 'Based on task hourly rate';
$lang['eventmanager_rate_per_hour']            = 'Rate Per Hour';
$lang['eventmanager_total_cost']            = 'Total Rate';
$lang['eventmanager_members']            = 'Members';
$lang['eventmanager_member_removed']     = 'Event member removed successfully';
$lang['eventmanager_overview']           = 'Event Overview';
$lang['eventmanager_gant']            = 'Gantt View';
$lang['eventmanager_milestones']            = 'Milestones';
$lang['eventmanager_milestone_order']            = 'Order';
$lang['eventmanager_milestone_duedate_passed']            = 'Due date passed';
...
$lang['eventmanager_milestone']            = 'Milestone';
$lang['eventmanager_notes']            = 'Notes';
$lang['eventmanager_timesheets']            = 'Timesheets';
$lang['eventmanager_timesheet']            = 'Timesheet';
$lang['milestone_total_logged_time']            = 'Logged Time';
$lang['eventmanager_overview_total_logged_hours']            = 'Total Logged Hours';
$lang['milestones_uncategorized']            = 'Uncategorized';
$lang['milestone_no_tasks_found']            = 'No tasks found';
$lang['eventmanager_copied_successfully']            = 'eventmanager data copied successfully';
$lang['failed_to_copy_eventmanager']            = 'Failed to copy eventmanager';
$lang['copy_eventmanager_task_include_check_list_items']            = 'Copy checklist items';
$lang['copy_eventmanager_task_include_assignees']            = 'Copy the same assignees';
$lang['copy_eventmanager_task_include_followers']            = 'Copy the same followers';
$lang['eventmanager_days_left']            = 'Days Left';
$lang['eventmanager_open_tasks']            = 'Open Tasks';
$lang['timesheet_stop_timer']            = 'Stop Timer';
$lang['failed_to_add_eventmanager_timesheet_end_time_smaller']            = 'Failed to add timesheet. End time is smaller then start time';
$lang['eventmanager_timesheet_user']            = 'Member';
$lang['eventmanager_timesheet_start_time']            = 'Start Time';
$lang['eventmanager_timesheet_end_time']            = 'End Time';
$lang['eventmanager_timesheet_time_spend']            = 'Time Spent';
$lang['eventmanager_timesheet_task']            = 'Task';
$lang['eventmanager_invoices']                = 'Invoices';
$lang['total_logged_hours_by_staff']            = 'Total Logged Time';
$lang['invoice_eventmanager']            = 'Invoice eventmanager';
$lang['invoice_eventmanager_info']            = 'eventmanager Invoice Info';
$lang['invoice_eventmanager_data_single_line']            = 'Single line';
$lang['invoice_eventmanager_data_task_per_item']            = 'Task per item';
$lang['invoice_eventmanager_data_timesheets_individually']            = 'All timesheets individually';
$lang['invoice_eventmanager_item_name_data']            = 'Item name';
$lang['invoice_eventmanager_description_data']            = 'Description';
$lang['invoice_eventmanager_eventmanagername_taskname']            = 'eventmanager name + Task name';
$lang['invoice_eventmanager_all_tasks_total_logged_time']            = 'All tasks + total logged time per task';
$lang['invoice_eventmanager_eventmanager_name_data']            = 'eventmanager name';
$lang['invoice_eventmanager_timesheet_individually_data']            = 'Timesheet start time + end time + total logged time';
$lang['invoice_eventmanager_total_logged_time_data']            = 'Total logged time';
$lang['eventmanager_allow_client_to'] = 'Allow customer to %s';
$lang['eventmanager_setting_view_task_attachments'] = 'view task attachments';
$lang['eventmanager_setting_view_task_checklist_items'] = 'view task checklist items';
$lang['eventmanager_setting_upload_files'] = 'upload files';
$lang['eventmanager_setting_view_task_comments'] = 'view task comments';
$lang['eventmanager_setting_upload_on_tasks'] = 'upload attachments on tasks';
$lang['eventmanager_setting_view_task_total_logged_time'] = 'view task total logged time';
$lang['eventmanager_setting_open_discussions'] = 'open discussions';
$lang['eventmanager_setting_comment_on_tasks'] = 'comment on eventmanager tasks';
$lang['eventmanager_setting_view_tasks'] = 'view tasks';
$lang['eventmanager_setting_view_milestones'] = 'view milestones';
$lang['eventmanager_setting_view_gantt'] = 'view Gantt';
$lang['eventmanager_setting_view_timesheets'] = 'view timesheets';
$lang['eventmanager_setting_view_activity_log'] = 'view activity log';
$lang['eventmanager_setting_view_team_members'] = 'view team members';
$lang['eventmanager_discussion_visible_to_customer_yes']                 = 'Visible';
$lang['eventmanager_discussion_visible_to_customer_no']                 = 'Not Visible';
$lang['eventmanager_discussion_posted_on']                 = 'Posted on %s';
$lang['eventmanager_discussion_posted_by']                 = 'Posted by %s';
$lang['eventmanager_discussion_failed_to_delete']                 = 'Failed to delete discussion';
$lang['eventmanager_discussion_deleted']                 = 'Discussion deleted successfully';
$lang['eventmanager_discussion_no_activity']                 = 'No Activity';
$lang['eventmanager_discussion']                 = 'Discussion';
$lang['eventmanager_discussions']                 = 'Discussions';
$lang['edit_discussion'] = 'Edit Discussion';
$lang['new_eventmanager_discussion'] = 'Create Discussion';
$lang['eventmanager_discussion_subject'] = 'Subject';
$lang['eventmanager_discussion_description'] = 'Description';
$lang['eventmanager_discussion_show_to_customer'] = 'Visible to Customer';
$lang['eventmanager_discussion_total_comments'] = 'Total Comments';
$lang['eventmanager_discussion_last_activity'] = 'Last Activity';
...
$lang['eventmanager_note'] = 'Note';
$lang['eventmanager_note_private'] = 'Private notes';
$lang['eventmanager_save_note'] = 'Save note';
$lang['eventmanager_summary'] = 'Events Summary';
$lang['eventmanager_progress']= 'Progress';
$lang['eventmanager_send_created_email'] = 'Send event created email';
$lang['no_description_eventmanager'] = 'No description for this event';
$lang['invoice_eventmanager_see_billed_expenses']= 'See expenses that will be billed on this invoice';
$lang['eventmanager_overview_expenses'] = 'Total Expenses';
$lang['eventmanager_overview_expenses_billable'] = 'Billable Expenses';
$lang['eventmanager_overview_expenses_billed'] = 'Billed Expenses';
$lang['eventmanager_overview_expenses_unbilled'] = 'Unbilled Expenses';
$lang['eventmanager_tickets']                       = 'Tickets';
$lang['eventmanager_overview_logged_hours'] = 'Logged Hours:';
$lang['eventmanager_overview_billable_hours'] = 'Billable Hours:';
$lang['eventmanager_overview_billed_hours'] = 'Billed Hours:';
$lang['eventmanager_overview_unbilled_hours'] = 'Unbilled Hours:';
$lang['copy_eventmanager_tasks_status'] = 'Tasks Status';
$lang['eventmanager_timesheet_not_updated'] = 'Timesheet not affected';
$lang['eventmanager_invoice_task_no_timers_found'] = 'No timers found for this task';
$lang['invoice_eventmanager_tasks_not_started'] = 'Not yet started | Start Date: %s';
$lang['invoice_eventmanager_see_billed_tasks'] = 'See tasks that will be billed on this invoice';
$lang['invoice_eventmanager_all_billable_tasks_marked_as_finished'] = 'All billed tasks will be marked as finished';
$lang['invoice_eventmanager_nothing_to_bill'] = 'No tasks to bill. Feel free to add whatever you want in the invoice items.';
$lang['invoice_eventmanager_start_date_tasks_not_passed'] = 'Tasks with future start date cannot be billed';
$lang['invoice_eventmanager_stop_all_timers'] = 'Stop all timers';
$lang['invoice_eventmanager_stop_billable_timers_only'] = 'Stop only billable timers';

# Event Activity
$lang['eventmanager_activity_created'] = 'Created the eventmanager';
$lang['eventmanager_activity_updated'] = 'Updated eventmanager';
$lang['eventmanager_activity_removed_team_member'] = 'Removed team member';
$lang['eventmanager_activity_added_team_member'] = 'Added new team member';
$lang['eventmanager_activity_marked_all_tasks_as_complete'] = 'Marked all tasks as complete';
$lang['eventmanager_activity_recorded_timesheet'] = 'Recorded timesheet';
$lang['eventmanager_activity_task_name'] = 'Task:';
$lang['eventmanager_activity_deleted_discussion'] = 'Deleted Discussion';
$lang['eventmanager_activity_created_discussion'] = 'Created discussion';
$lang['eventmanager_activity_updated_discussion'] = 'Updated discussion';
$lang['eventmanager_activity_commented_on_discussion'] = 'Commented on discussion';
$lang['eventmanager_activity_deleted_discussion_comment'] = 'Deleted discussion comment';
$lang['eventmanager_activity_deleted_milestone'] = 'Deleted milestone';
$lang['eventmanager_activity_updated_milestone'] = 'Updated milestone';
$lang['eventmanager_activity_created_milestone'] = 'Created new milestone';
$lang['eventmanager_activity_invoiced_eventmanager'] = 'Invoiced eventmanager';
$lang['eventmanager_activity_task_marked_complete'] = 'Task marked as complete';
$lang['eventmanager_activity_task_unmarked_complete'] = 'Task unmarked as complete';
$lang['eventmanager_activity_task_deleted'] = 'Task deleted';
$lang['eventmanager_activity_new_task_comment'] = 'Commented on task';
$lang['eventmanager_activity_new_task_attachment'] = 'Uploaded attachment on task';
$lang['eventmanager_activity_new_task_assignee'] = 'Added new task assignee';
$lang['eventmanager_activity_task_assignee_removed'] = 'Removed task assignee';
$lang['eventmanager_activity_task_timesheet_deleted'] = 'Removed timesheet';
$lang['eventmanager_activity_uploaded_file'] = 'Uploaded eventmanager file';
$lang['eventmanager_activity_status_updated'] = 'Updated eventmanager status';
$lang['eventmanager_activity_visible_to_customer'] = 'Visible to customer';
$lang['eventmanager_activity_eventmanager_file_removed'] = 'Removed project file';
...
$lang['clients_nav_eventmanager'] = 'Events';
$lang['clients_my_eventmanager'] = 'Events';
...
$lang['eventmanager_invoice_select_all_tasks'] = 'Select all tasks';
...
$lang['pin_eventmanager']= 'Pin Event';
$lang['unpin_eventmanager']= 'Unpin Event';
...
$lang['eventmanager_setting_view_finance_overview'] = 'view finance overview';
...
$lang['not_uploaded_eventmanager_file'] = 'New file uploaded';
$lang['not_created_new_event_discussion'] = 'New project discussion created';
$lang['not_commented_on_eventt_discussion'] = 'New comment on project discussion';
...
$lang['help_eventmanager_permissions'] = 'VIEW allows staff member to see ALL events. If you only want them to see events they are assigned (added as members), do not give VIEW permissions.';
...
$lang['notify_eventmanager_members_status_change'] = 'Notify event members that status is changed';
$lang['not_project_status_updated'] = 'Event status updated from %s to %s';
$lang['not_eventmanager_status_updated'] = 'Event status updated from %s to %s';
$lang['ticket_not_found'] = 'Ticket not found';
$lang['project_not_found'] = 'Project not found';
$lang['eventmanager_not_found'] = 'Event not found';
$lang['export_project_data'] = 'Export project data';
$lang['export_eventmanager_data'] = 'Export event data';
...
$lang['total_eventmanager_members'] = 'Total Event Members';
$lang['total_eventmanager_files'] = 'Files attached';
$lang['total_eventmanager_discussions_created'] = 'Discussions created';
$lang['eventmanager_member'] = 'Member';
$lang['total_eventmanager_discussions_comments'] = 'Total discussion comments';
...
$lang['eventmanager_members_overview'] = 'Event members overview';
$lang['eventmanager_milestones_overview'] = 'Milestones overview';
...
$lang['eventmanager_mark_as'] = 'Mark as %s';
...
$lang['eventmanager_mark_tasks_finished_confirm'] = 'Confirm';
$lang['eventmanager_marked_as_success'] = 'Event marked as %s successfully';
$lang['eventmanager_marked_as_failed'] = 'Failed to mark event as %s';
...
$lang['eventmanager_completed_date'] = 'Completed Date';
...
$lang['eventmanager_setting_create_tasks'] = 'create tasks';
$lang['eventmanager_setting_edit_tasks'] = 'edit tasks (only tasks created from contact)';
...
$lang['no_eventmilestones_found'] = 'This event has no milestones';
